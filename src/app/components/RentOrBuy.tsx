    ...
    <section className="relative w-full bg-white py-4 lg:py-12 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
          {/* Card 1 */}
          <div className="bg-[#f8f9fa] rounded-3xl p-8 lg:p-10 flex flex-col items-start h-full">
            ...
            <h4 className="text-[22px] font-bold text-black mb-3 text-left">
              Clarity drives action
            </h4>
            <p className="font-serif text-[18px] lg:text-[19px] text-[#3f3f46] leading-tight text-left">
